...
{
    public class CustomePrinerterTests
   {
        public CustomePrinerterTests(ITestOutputHelper output)
        {
        ...
        public void CustomePrinerterTest_SimpleTypes()
        {
            const int x = 1;
            const double y = 1.2;
        ...
        [Fact]
        [Trait(Category.AcceptanceType, Category.CheckIn)]
        public void CustomePrinerterTest_ComplexTypes()
        {
