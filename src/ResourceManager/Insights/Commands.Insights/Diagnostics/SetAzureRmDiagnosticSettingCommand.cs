...
namespace Microsoft.Azure.Commands.Insights.Diagnostics
{
    ...
    public class SetAzureRmDiagnosticSettingCommand : ManagementCmdletBase
    {
        ...
        protected override void ProcessRecordInternal()
        {
            ...
            DiagnosticSettingsResource resource = this.MonitorManagementClient.DiagnosticSettings.CreateOrUpdateAsync(resourceUri: this.ResourceId, name: properties.Name, parameters: putParameters, cancellationToken: CancellationToken.None).Result;
            var result = new PSServiceDiagnosticSettings(resource);
            WriteObject(result);
        }
