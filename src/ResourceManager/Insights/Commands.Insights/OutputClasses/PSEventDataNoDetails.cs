...
namespace Microsoft.Azure.Commands.Insights.OutputClasses
{
    ...
    public class PSEventDataNoDetails : PSEventData
    {
        ...
        public PSEventDataNoDetails(EventData eventData)
            : base(eventData)
        {
            this.Category = new PSLocalizableStringNoDetails(eventData.Category);
            this.OperationName = new PSLocalizableStringNoDetails(eventData.OperationName);
            this.Status = new PSLocalizableStringNoDetails(eventData.Status);
            this.SubStatus = new PSLocalizableStringNoDetails(eventData.SubStatus);
        }
    }
}
