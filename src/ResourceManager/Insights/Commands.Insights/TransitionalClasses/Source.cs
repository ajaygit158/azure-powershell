...
namespace Microsoft.Azure.Management.Monitor.Management.Models
{
    ...
    /// </summary>
    public class Source : Monitor.Models.Source
    {
        public Source() : base()
        { }
        /// <summary>
        ...
        /// </summary>
        /// <param name="source">The Source of the LogSearchRuleResource object</param>
        public Source(Monitor.Models.Source source) :
            base(
                query : source?.Query,
